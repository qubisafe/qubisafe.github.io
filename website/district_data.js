const data = {
  ...
  "Andhra Pradesh": [
    ...
    "Kurnool","Markapuram","Nandyal","Ntr","Palnadu","Parvathipuram Manyam",
    "Polavaram","Prakasam","Sri Potti Sriramulu Nellore","Sri Sathya Sai","Srikakulam","Tirupati",
  ...
  "Assam": [
    ...
    "Kamrup","Kamrup Metro","Karbi Anglong","Kokrajhar","Lakhimpur","Majuli",
    "Marigaon","Nagaon","Nalbari","Sivasagar","Sonitpur","South Salmara Mancachar",
  ...
  "Bihar": [
    ...
    "Pashchim Champaran","Patna","Purbi Champaran","Purnia","Rohtas","Saharsa",
  ...
  "Chhattisgarh": [
    ...
    "Korea","Mahasamund","Manendragarh-Chirmiri-Bharatpur(M C B)","Mohla-Manpur-Ambagarh Chouki","Mungeli","Narayanpur",
    "Raigarh","Raipur","Rajnandgaon","Sakti","Sarangarh-Bilaigarh","Sukma",
    "Surajpur","Surguja","Uttar Bastar Kanker"
  ],
  "Delhi": [
    "Central","Central North","East","New Delhi","North","North East",
    "North West","Old Delhi","Outer North","South","South East","South West",
    "West"
  ],
  "Goa": [
  ...
  "Gujarat": [
    ...
    "Bhavnagar","Botad","Chhotaudepur","Dahod","Dangs","Devbhumi Dwarka",
  ...
  "Haryana": [
    ...
    "Hansi","Hisar","Jhajjar","Jind","Kaithal","Karnal",
  ...
  "Jharkhand": [
    "Bokaro","Chatra","Deoghar","Dhanbad","Dumka","East Singhbum",
  ...
  "Madhya Pradesh": [
    ...
    "Morena","Narmadapuram","Narsimhapur","Neemuch","Niwari","Pandhurna",
  ...
  "Rajasthan": [
    "Ajmer","Alwar","Balotra","Banswara","Baran","Barmer",
    ...
    "Jhunjhunu","Jodhpur","Karauli","Khairthal-Tijara","Kota","Kotputli-Behror",
  ...
  "Telangana": [
    ...
    "Jayashankar Bhupalapally","Jogulamba Gadwal","Kamareddy","Karimnagar","Khammam","Kumuram Bheem Asifabad",
  ...
  "Uttar Pradesh": [
    ...
    "Lucknow","Mahoba","Mahrajganj","Mainpuri","Mathura","Mau",
